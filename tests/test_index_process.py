...
def test_initialize_index_full_flow_subtests():
    ...
    index1 = manager.initialize_index(force_rebuild=False)
    ...
    index2 = manager.initialize_index(force_rebuild=False)
    ...
    index3 = manager.initialize_index(force_rebuild=True)
    ...
    index4 = manager.initialize_index(force_rebuild=False)
